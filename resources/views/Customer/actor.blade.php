                ...
                <div class="position-relative top-50 start-50 translate-middle col-12">
                    <div class="row mt-lg-5">
                        <div class="col-12 d-block">
                            <img class="col-4 d-block my-2 mx-auto" src="{{asset(\Illuminate\Support\Facades\Storage::url('img/actor/').$actor -> actor_image)}}" style="border-radius: 50%; overflow: hidden; height: 8vmax; width: 8vmax;" alt="">
