        ...
        <section id="movie__overview" class="row position:relative">
            ...
            <section class="p-0 top-0 start-0 bottom-1 end-0">
                <div class="background">
                    <img src="{{asset(\Illuminate\Support\Facades\Storage::url('img/actor/').$actor -> actor_image)}}" style="object-fit: cover; opacity: 0.8;" class="full-screen-element col-12">
                    </img>
                </div>
            </section>
                ...
                <div class="position-relative top-50 start-50 translate-middle col-12">
                    <div class="row mt-lg-5">
                        <div class="col-12 d-block">
                            <img class="col-4 d-block my-2 mx-auto" src="{{asset(\Illuminate\Support\Facades\Storage::url('img/actor/').$actor -> actor_image)}}" style="border-radius: 50%;object-fit: cover; overflow: hidden; height: 8vmax; width: 8vmax;" alt="">
                            <p class="text-center text-light fw-bold mb-1" style="font-size: 2vmax;">{{$actor -> actor_name}}</p>
                        </div>
                    </div>
