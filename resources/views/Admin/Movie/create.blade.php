...
<head>
    ...
    <title>Netfnix - Movie Management - Upload movie</title>
                                ...
                                <div class="row">
                                    <div class="col-8">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="date" class="form-control bg-dark border-0 shadow-none text-light" id="movie_release_date" name="movie_release_date" required>
                                        </div>

                                        <div class="mb-3">
                                            <label for="movie_release_date" class="form-label text-light">End date</label>
                                            <input type="date" class="form-control bg-dark border-0 shadow-none text-light" id="movie_end_date" name="movie_end_date" required>
                                        </div>
