...
<head>
    ...
    <title>Netfnix - Member Management - Category</title>
                ...
                <div class="row">
                    <div class="col-3 shadow p-3 bg-dark rounded mb-3 min-vh-100">
                        <div class="btn-group-vertical col-12 " role="group" aria-label="Basic example">
                            ...
                            <a href="" class="btn border-0 rounded text-start text-dark bg-danger" tabindex="-1" role="button" aria-disabled="true">Film genre management</a>
                                ...
                                <table class="table my-3 text-light">
                                    ...
                                    @foreach($categories as $category)
                                        ...
                                        <tr>
                                            ...
                                            <td class="col-2">
                                                <a href="{{route('admin.categories.edit', $category)}}" type="button" class="btn btn-outline-light my-1" tabindex="-1" role="button" aria-disabled="true">
